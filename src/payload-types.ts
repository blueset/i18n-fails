...
export interface Config {
  ...
  collectionsJoins: {
    ...
    languages: {
      sourceLanguageOf: 'posts';
      destinationLanguageOf: 'posts';
    };
  };
  collectionsSelect: {
...
export interface Page {
  ...
  layout: (CallToActionBlock | ContentBlock | MediaBlock | ArchiveBlock | FormBlock | TaxonomyBlock)[];
  meta?: {
    title?: string | null;
    /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaxonomyBlock".
 */
export interface TaxonomyBlock {
  ...
  taxonomiesToShow?:
    | ('vendors' | 'products' | 'languages' | 'sourceLanguages' | 'targetLanguages' | 'categories')[]
    | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'taxonomy';
...
export interface PayloadMcpApiKey {
  ...
  languages?: {
    /**
     * Allow clients to find languages.
     */
    find?: boolean | null;
    /**
     * Allow clients to create languages.
     */
    create?: boolean | null;
    /**
     * Allow clients to update languages.
     */
    update?: boolean | null;
    /**
     * Allow clients to delete languages.
     */
    delete?: boolean | null;
  };
  'payload-mcp-tool'?: {
    /**
     * Convert HTML to Lexical Rich Text JSON serializer
     */
    htmlToLexical?: boolean | null;
    /**
     * Get an authentication token for the current user
     */
    getUserAuthToken?: boolean | null;
  };
  'payload-mcp-resource'?: {
    /**
     * Categories available for use in posts.
     */
    getCategories?: boolean | null;
    /**
     * Products available for use in posts.
     */
    getProducts?: boolean | null;
  };
  'payload-mcp-prompt'?: {
    /**
    ...
    /**
     * Create a new post based on the provided screenshots.
     */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        taxonomy?: T | TaxonomyBlockSelect<T>;
      };
  meta?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaxonomyBlock_select".
 */
export interface TaxonomyBlockSelect<T extends boolean = true> {
  introContent?: T;
  taxonomiesToShow?: T;
  id?: T;
  blockName?: T;
